...
wb = xlrd.open_workbook("D:/pythonwork/paper2024/mooc/alternative labelled data/Java（82）.xls")
...
for i in tqdm(range(1, rows)):
    ...
    for j in list1:
        if is_contains_chinese(j) and len(j) >= 5:  # 过滤掉不包含中文及字数少于5的句子
...
for i in range(len(sentences)):
    ...
    row += 1
book.save("D:/pythonwork/paper2024/mooc/alternative labelled data/Java（82）_切分句子后.xls")